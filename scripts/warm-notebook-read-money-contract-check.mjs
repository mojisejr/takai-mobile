...
for (const marker of ['PaymentScreen', 'เลือกค่าแรงค้างจ่าย', 'PaymentSettlementRow', 'ชุดรับเงินจ่ายเป็นก้อนเดียว จึงไม่มีการหักเงินเบิก', 'advanceRecoveries']) if (!source.includes(marker)) fail(`Payment must preserve group and person-only advance language: ${marker}`);
