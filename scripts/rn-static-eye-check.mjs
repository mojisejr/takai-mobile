...
const checks = ['test:warm-notebook-foundation', 'test:warm-notebook-primitives', 'test:warm-notebook-read-money', 'test:warm-notebook-record', 'test:warm-notebook-responsive', 'test:design-contract', 'test:labor-navigation-ui', 'test:labor-v2-plot-ui', 'test:labor-v2-chemical-ui', 'test:labor-v2-task-chemical-mix', 'test:labor-v2-chemical-history-proof', 'test:labor-read-ui', 'test:labor-v2-read-navigation-ui', 'test:labor-write-ui', 'test:labor-payment-batch-ui', 'test:labor-notebook-boundary'];
