...
assert.ok(design.includes('.oracle-eye/rn-web/takai-warm-notebook-ui-redesign/'), 'DESIGN.md must point to the Warm Notebook RN Web evidence sink');
assert.ok(eye.includes("'takai-warm-notebook-ui-redesign'"), 'RN Web harness default must point to the Warm Notebook evidence sink');
