...
const styles = StyleSheet.create({
  feedbackBackdrop: { alignItems: 'center', backgroundColor: 'rgba(31,45,31,0.35)', flex: 1, justifyContent: 'center', padding: tokens.spacing.page }, feedbackDialog: { alignItems: 'stretch', backgroundColor: tokens.color.surface.card, borderRadius: tokens.radius.card, gap: 12, maxWidth: 420, padding: 20, width: '100%' }, feedbackMark: { alignSelf: 'center', color: tokens.color.primary.green, fontSize: 34, fontWeight: '800' }, feedbackTitle: { color: tokens.color.text.primary, fontSize: tokens.typography.h2.size, fontWeight: '800', textAlign: 'center' }, feedbackText: { color: tokens.color.text.muted, fontSize: tokens.typography.body.size, lineHeight: 23, textAlign: 'center' },
